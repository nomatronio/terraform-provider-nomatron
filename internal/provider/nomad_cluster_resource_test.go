...
func TestNewNomadClusterResource(t *testing.T) {
	t.Parallel()

	r := NewNomadClusterResource()
	if r == nil {
		t.Fatal("expected resource to be non-nil")
	}

	if _, ok := r.(*NomadClusterResource); !ok {
		t.Fatalf("expected *NomadClusterResource, got %T", r)
	}
}

func TestNomadClusterResource_Metadata(t *testing.T) {
	t.Parallel()

	r := &NomadClusterResource{}
...
func TestNomadClusterResource_Schema(t *testing.T) {
	t.Parallel()
	...
	assertResourceStringAttribute(t, attrs, "acl_token", false, true, false, true)
	assertResourceStringAttribute(t, attrs, "ca_cert", false, true, false, true)
	assertResourceStringAttribute(t, attrs, "tls_cert", false, true, false, true)
	assertResourceStringAttribute(t, attrs, "tls_key", false, true, false, true)
...
func TestNomadClusterResource_ConfigureNilProviderData(t *testing.T) {
	t.Parallel()
...
func TestNomadClusterResource_ConfigureWrongType(t *testing.T) {
	t.Parallel()
...
func TestStateFromNomadCluster(t *testing.T) {
	t.Parallel()
...
func TestNomadClusterNotFoundError(t *testing.T) {
	t.Parallel()

	err := &nomadClusterNotFoundError{name: "primary"}
	if !isNomadClusterNotFound(err) {
		t.Fatal("expected nomadClusterNotFoundError to be recognized")
	}
	if isNomadClusterNotFound(errors.New("other")) {
